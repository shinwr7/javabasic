...
public class Darkelf {
		...
		public void battleWithWarrior (Warrior w) {
			...
			System.out.println("다크엘프가 "+(atk-def)+"만큼의 피해를 입혔습니다.");
			
			
			
			if(w.getHp()<=0) {
				System.out.println("다크엘프가 전사를 살해");
				return;
			}
			
		}
		public void getDragonInfo() {
			System.out.println("-----다크엘프 상태-----");
		...
		public void battlewithPriest (Priest p) {
			...
			if(p.getHp()<=0) {
				System.out.println("다크엘프가 성직자를 살해");
				return;
		}}
